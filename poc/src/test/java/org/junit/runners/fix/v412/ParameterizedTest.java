...
public class ParameterizedTest {
    ...
    @RunWith(org.junit.runners.fix.v412.Parameterized.class)
    public static class PatchedParameterizedWithEscapeSequenceInNameTest_Junit412 {

        @org.junit.runners.fix.v412.Parameterized.Parameters(name = "{0}")
        public static Collection<Character[]> parameters() {

            final Set<Character> charactersToEscape = org.junit.runners.fix.v412.Parameterized.ESCAPE_SEQUENCES.keySet();
        ...
        public PatchedParameterizedWithEscapeSequenceInNameTest_Junit412(final Character character) {
        }
    ...
    @Test
    public void parameterizedTest_displaysEscapeSequencesInName_forJUnit412() {

        final Request request = Request.aClass(PatchedParameterizedWithEscapeSequenceInNameTest_Junit412.class);
